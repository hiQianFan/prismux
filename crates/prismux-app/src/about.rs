...
use prismux_core::{Result, storage};
    ...
    Ok(AboutView {
        ...
        links: vec![
            AboutLink {
                ...
                url: "https://github.com/hiQianFan/prismux".to_string(),
            },
            AboutLink {
                label: "Documentation".to_string(),
                url: "https://github.com/hiQianFan/prismux/tree/main/docs".to_string(),
            },
            AboutLink {
                label: "Issues".to_string(),
                url: "https://github.com/hiQianFan/prismux/issues".to_string(),
            },
            AboutLink {
                label: "Releases".to_string(),
                url: "https://github.com/hiQianFan/prismux/releases".to_string(),
            },
        ],
        author_links: vec![
            AboutLink {
