...
if grep -RInE 'access_token|refresh_token|api_key|authorization:|bearer |sk-|raw auth|raw log|raw response' \
...
if grep -RInE 'TBCore|tb_core_ffi|TokenBar|tokscale|scanner|pricing|quota fetcher|com\.tokenbar|TBUserDefaults|tokenbar' \
